...
ACTIONS = ["STAY", "RIGHT", "LEFT", "DOWN", "UP", "SHOOT", "HIT", "CRAFT", "GATHER", "NONE"]
ref = {}
states = {}
idx = 0 
                ...
                for h in HEALTH:
                    ...
                    if p == "W":
                        ...
                        if mm == 'D':
                            ...
                            states[now].actions["STAY"].add_transition(ref[(p, m, a, mm, h)], .5 * .85)
                            states[now].actions["STAY"].add_transition(ref[(p, m, a, 'D', h)], .5 * .85)

                            states[now].actions["STAY"].add_transition(ref[("E", m, a, mm, h)], .5 * .15)
                            states[now].actions["STAY"].add_transition(ref[("E", m, a, 'D', h)], .5 * .15)

                            states[now].actions["UP"].add_transition(ref[("C", m, a, mm, h)], .5 * .85)
                            states[now].actions["UP"].add_transition(ref[("C", m, a, 'D', h)], .5 * .85)
                            
                            states[now].actions["UP"].add_transition(ref[("E", m, a, mm, h)], .5 * .15)
                            states[now].actions["UP"].add_transition(ref[("E", m, a, 'D', h)], .5 * .15)

                            states[now].actions["GATHER"].add_transition(ref[(p, min(m+1, 2), a, mm, h)], 0.5 * .75)
                            states[now].actions["GATHER"].add_transition(ref[(p, min(m+1, 2), a, 'D', h)], 0.5 * .75)
                            
                            states[now].actions["GATHER"].add_transition(ref[(p, m, a, mm, h)], .5 * .25)
                            states[now].actions["GATHER"].add_transition(ref[(p, m, a, 'D', h)], .5 * 0.25)
                        ...
                        if mm == 'D' :
                            ...
                            if a > 0:
                                states[now].actions["SHOOT"].add_transition(ref[(p, m, a - 1, mm, h - 25)], 0.5 * .5)
                                states[now].actions["SHOOT"].add_transition(ref[(p, m, a - 1, mm, h)], 0.5 * .5)
